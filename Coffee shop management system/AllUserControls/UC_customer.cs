...
namespace Coffee_shop_management_system.AllUserControls
{
    public partial class UC_customer : UserControl
    {
        ...
        private void btninsert_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("insert into customer (Customer_Name,Email,PhoneNo,Address,City) values(@Customer_Name,@Email,@PhoneNo,@Address,@City)", conn);
        ...
        private void DisplayData()
        {
            ...
            adapt = new SqlDataAdapter("select * from customer", conn);
            adapt.Fill(dt);
        ...
        private void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("update customer set Customer_Name=@Customer_Name,Email=@Email,PhoneNo=@PhoneNo,Address=@Address,City=@City where Customer_ID=@Customer_ID", conn);
